...
@section('title', 'Pengaturan - Peserta SIAP PKL')
        ...
        <div class="student-topbar">
            <div style="display: flex; align-items: center;">
                ...
                <div>
                    ...
                    <h1 style="font-size: 1.25rem; font-weight: 800; color: #1E293B; letter-spacing: -0.02em;">Pengaturan Akun</h1>
                </div>
            </div>
        </div>

        <div class="student-content" style="max-width: 600px;">
            ...
            <div class="modern-card">
                ...
                <form action="{{ route('peserta.update_password') }}" method="POST">
                    @csrf
